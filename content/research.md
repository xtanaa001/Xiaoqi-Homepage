...
Motivated by these challenges, my research centers around  the interplay between  algorithms,   incentives, and learning in networking and energy systems. To be more specific, my research focuses both on developing analytical techniques in online algorithms, algorithmic game theory, optimization, and machine learning, and applying these techniques in networking and energy domains such as cloud computing, network economics, and smart grid. For more details, please see my research description below by topics. 
