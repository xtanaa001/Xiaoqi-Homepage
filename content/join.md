...
We are a research group based at CS@UAlberta, striving to optimize the design and operation of networked systems in dynamic, complex environments. Our mission is to conduct impactful interdisciplineary research in the general field of "`decisions under uncertainty`" using mathematical tools from computer science, economics, and control.  If you are interested in joining the group as an undergraduate, graduate, or postdoc, see the description below. 
