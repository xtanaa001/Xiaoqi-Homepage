...
Xiaoqi's research interests span various topics in online algorithms, optimization under uncertainty, and algorithmic game theory, with applications to networked and multi-agent systems of various types, ranging from energy systems to transportation systems, communication networks, and beyond. The main theme of his research is to develop new decision-making tools and algorithms under different forms of uncertainty, with provable performance guarantees, using mathematical tools from computer science, operations research, economics, and control.
