...
>
Xiaoqi’s research interests span various topics in optimization and decision-making under uncertainty, with a particular focus on the theory of online algorithms and its implications for problems at the interface of multi-agent systems, economics and computation (e.g., incentives/auctions/mechanism design; algorithmic economics/game theory; multi-agent decision-making).
