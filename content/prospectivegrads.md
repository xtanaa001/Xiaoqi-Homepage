...
I am [**Xiaoqi Tan**](/), an Assistant Professor of [**Computing Science**](https://www.ualberta.ca/computing-science/index.html) at the [**University of Alberta**](https://www.ualberta.ca) and also a [**Fellow**](https://www.amii.ca/about/our-people/) of the [**Alberta Machine Intelligence Instittue (Amii)**](https://www.amii.ca). My research interests span various topics in “**_optimization and decision-making under uncertainty_**,” with an emphasis on exploring the interplay between _**algorithms**_ (for optimization and control), _**learning**_ (for prediction), and _**incentives**_ (for modeling strategic behaviors) in online and multi-agent decision-making. 
