...
> 
My research focuses on problems at the intersection of <span style="color:#E78100">Algorithms</span>, <span style="color:#E78100">Incentives</span>, and <span style="color:#E78100">Learning</span>, with  applications to networked systems ranging from <span style="color:#E78100">Computer Systems and Networks</span> to <span style="color:#E78100">Cyber-Physical Systems</span> (e.g., energy, transportation, and green IT). I am particularly interested in <span style="color:#E78100">Online Algorithms</span> (i.e., algorithm design for optimization and learning problems without having the entire input/data available from the start) and <span style="color:#E78100">Mechanism Design</span> (i.e., algorithm design in settings when there exist strategic interactions between self-interested agents). My research spans various topics in computer science, electrical engineering, and operations research, using tools from optimization, economics, algorithms and complexity, artificial intelligence (esp. multi-agent systems), machine learning, network science, applied probability, and information theory. For more details, see my publications below [by type](/publications_type) or [by year](/publications_year).
