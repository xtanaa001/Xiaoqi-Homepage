...
My research focuses on online algorithms, algorithmic game theory, and mechanism design, with an emphasis on applications to the design and operation of large-scale networked systems, e.g., cloud computing, computer networks,  and smart grids. For more details, please see my recent publications below, or click [here](/publications) for my full publication list.
