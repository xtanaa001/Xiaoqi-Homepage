...
>
Xiaoqi’s research focuses on optimization and decision-making under uncertainty, using tools and insights from computer science, economics, and operations research.  On the practical side, Xiaoqi is also interested in developing new algorithms with provable guarantees to address real-world systems challenges across various fields, including electrical grids, transportation systems, and computing systems and networks.
