...
My research strives to **understand fundamental properties and design principles of large-scale networked systems in the presence of uncertainty, multi-agent interactions, and  possibly strategic behaviors**. In particular, most of my research focuses on developing new mathematical tools in sequential decision-making (e.g., online/stochastic optimization; online/reinforcement learning) and algorithmic mechanism design, with applications to computer systems & networks, energy systems, electric vehicle networks, and beyond.  Click [here](/publications_year) for more details.
