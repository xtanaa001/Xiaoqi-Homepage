...
My research spans various topics in [**online algorithms**](/research/#online_algorithms),   [**algorithmic game theory, and mechanism design**](/research/#mechanism_design), with a focus on applications in [**cloud computing**](/research/#cloud_computing),  [**network economics**](/research/#networking),  [**energy-efficient networking**](/research/#networking), and [**smart grid**](/research/#smart_grid). The main theme of my research is to develop algorithms and incentives for [**networked systems and platforms**](/research/#research_overview) in the presence of strategic behaviors and uncertainty, using tools from mathematics, economics, and engineering.
