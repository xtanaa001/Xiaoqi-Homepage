...
My research focuses on understanding fundamental principles for the design and operation of large-scale networked systems using tools from optimization and algorithmic game theory, with an emphasis on applications to cloud computing, computer networks,  and smart grids. For more details, please see my recent publications below, or click [here](/publications) for my full publication list.
