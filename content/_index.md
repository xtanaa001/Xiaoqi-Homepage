...
>
Xiaoqi’s research strives to optimize decision-making in dynamic, uncertain, and possibly strategic environments, using mathematical tools from computer science, economics, statistics, and control. Specifically, his current research spans various theoretic topics in the general field of _decision-making under uncertainty_, including online optimization, algorithmic game theory, and sequential decision/learning theory. On the practical side, Xiaoqi is also interested in developing new algorithmic solutions with provable guarantees to address real-world challenges in _dynamic, networked systems_ across various fields, including electrical grids, transportation systems, and communication networks. For more details, see his [**SODALab**](https://sodalab.ca) page.
