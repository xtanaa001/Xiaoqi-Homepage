...
My research strives to understand fundamental performance limits and design principles of large-scale networked systems in the presence of uncertainty, multi-agent interactions, and even self-interest. To deal with these challenging settings, most of my research focuses on developing foundational theories and methodologies in online decision making under uncertainty and algorithmic mechanism design, using mathematical tools from optimization, machine learning, and economics. On the practical side, I am passionate about applying these techniques to address key societal challenges in a variety of application areas, ranging from computer systems and networks (e.g., cloud computing, energy-efficient networking, and Internet-of-Things) to cyber-physical systems (e.g., smart grid and electric vehicle networks). Click [here](/publications_year) for more details.
