...
I study the interplay between algorithms, decisions, and uncertainty in networked systems -- especially in highly dynamic, strategic settings where multiple intelligent agents come together, interact and possibly pursue divergent or even conflicting objectives. The goal is to develop new decision-making tools and algorithms, with provable performance guarantees, under different forms of uncertainty, using mathematical tools from computer science, optimization, economics, and control. On the practical side, my research is primarily driven by real-world applications in energy,  transportation, sustainability, and resource allocation.  
