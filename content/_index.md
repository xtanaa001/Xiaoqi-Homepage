...
Xiaoqi’s research interests span various topics in optimization and decision-making under uncertainty, with an emphasis on exploring the interplay between _algorithms_, _incentives_ (for modeling strategic behaviors), and _learning_ (for prediction) in online and multi-agent decision-making. For more details, please visit his research website -- [**SODALab.ca**](https://sodalab.ca). 
