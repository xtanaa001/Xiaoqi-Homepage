...
My research strives to understand fundamental performance limits and design principles of large-scale networked systems in the presence of uncertainty  and self-interest. To deal with these challenging settings, my research focuses on developing foundatioal theories and methodologies in online decision making under uncertainty (e.g., online optimization and online learning) and algorithmic mechanism design. On the practical side, I am passionate about applying these techniques to address key societal challenges in a variety of application domains, ranging from computer systems \& networks (e.g., cloud computing, energy-efficient networking, and Internet-of-Things) to cyber-physical systems (e.g., smart grid and electric vehicle networks). Click [here](/publications_year) for more details.
