...
My research strives to understand fundamental performance limits and design principles of networked systems in the presence of interacting agents and stochastic dynamics, using  tools from optimization, economics, artificial intelligence (e.g., multi-agent systems), and machine learning. In particular, my recent research focuses primarily on online decision making under uncertainty and algorithmic mechanism design. On the practical side, I am passionate about applying these techniques to address key societal challenges in a variety of application areas, including computer systems \& networks (e.g., cloud computing, energy-efficient networking, and Internet of Things) and cyber-physical systems (e.g., smart grid and the urban energy-transport nexus). Click [here](/publications_year) for more details.
