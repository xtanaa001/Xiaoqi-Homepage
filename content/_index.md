...
>
Xiaoqi Tan's research strives to develop efficient, robust, and explainable solutions to decision-making problems in dynamical, networked systems. The main theme of his research is to develop new analytical and computational tools in the general field of "[**optimization and decision-making under uncertainty**](/teaching/optimization)" and apply these tools to develop new algorithms and markets with provable guarantees in  energy systems, transportation systems, networking and distributed systems, and beyond. Lately, his research focuses primarily on [**online optimization**](https://en.wikipedia.org/wiki/Online_optimization) and [**mechanism design**](https://en.wikipedia.org/wiki/Mechanism_design), with particular emphasis on exploring the interplay between algorithms, incentives (for modeling strategic behaviors), and data for online decision-making in large-scale dynamical, multi-agent systems. 
