...
>
Xiaoqi Tan’s research broadly intersects systems, algorithms, and economics, focusing on addressing uncertainty in system modeling, optimization, and decision-making. In particular, he develops algorithms with provable guarantees to optimize sequential decision-making under uncertainty and strategic behaviors ([**online algorithms**](https://sodalab.ca/research/#online); [**mechanism design**](https://sodalab.ca/research/#incentives)). On the applied side, his research aims to address environmental and economic sustainability challenges in networked systems and markets across various domains, including energy, transportation, cloud computing, and networking.
