...
>
Xiaoqi’s research strives to optimize decision-making in dynamic, uncertain, and possibly strategic environments, using mathematical tools from computer science, economics, statistics, and control. Specifically, his current research spans various theoretical topics in the general field of _decision-making under uncertainty_, including online optimization, algorithmic game theory, and sequential decision and learning theory. On the practical side, Xiaoqi is also interested in developing new algorithms and markets with provable guarantees to address real-world challenges in _dynamic, networked systems_ across various fields, including electrical grids, transportation systems, and computing systems and networks. 
