...
My research spans various topics in [**online algorithms**](/research/#online_algorithms),  [**algorithmic game theory**](/research/#mechanism_design), and [**networked systems and platforms**](/research/#research_overview), with a focus on applications in [**cloud computing**](/research/#cloud_computing),  [**communication networks**](/research/#networking),  and [**smart grid**](/research/#smart_grid). The central theme of my research is to develop algorithms and incentives for systems of interacting and possibly self-interested agents in the face of uncertainty, using tools from mathematics, engineering and sometimes economics.
