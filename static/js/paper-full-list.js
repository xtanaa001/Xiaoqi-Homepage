var papers_full = new Array ( 
    ...
    //     id : "OMSBC_2026",
    //     name : "XXX",
    //     coauthors : new Array(authorList.LHallett, authorList.HSang, authorList.XQTan),
    //     conference : "Preprint",
    //     //pubinfo: "",
    //     arxiv: "",
    ...
    // {
    //     id : "Quota_2026",
    //     name : "Repeated Online Multi-Agent Allocation with Soft Quotas",
    //     coauthors : new Array(authorList.FZargari, authorList.SYu, authorList.YRLi, authorList.XQTan),
    //     conference : "Preprint",
    //     //pubinfo: "",
    //     arxiv: "",
    //     //pdf: "/documents/abc.pdf",
    ...
    //     year: "Preprint",
    //     //note: "Full version is available upon request",
    //     paperAbstract : "<p>We study repeated online multi-agent resource allocation under soft quota constraints, where a decision-maker must allocate a limited resource to sequentially arriving requests while balancing total value and penalties for deviating from agent-specific target allocations. This setting captures modern systems such as multi-tenant LLM inference and cloud resource management, where both under- and over-allocation incur costs.  For linear penalties, we develop two optimal algorithms with fundamentally different design principles: (i) a compensatory multi-threshold policy that achieves the optimal competitive ratio in the symmetric regime, and (ii) a novel algorithm that departs from threshold-based designs and attains optimal performance in the general setting via a parameterized dual-fitting approach. We further extend our framework to general convex penalties. We show that the problem loses its finite-dimensional structure in this regime, and propose a piecewise-linear approximation scheme that reduces the problem to a sequence of tractable linear instances. This yields algorithms with competitive ratio arbitrarily close to optimal, with an explicit trade-off between approximation accuracy and computational complexity. Finally, we validate our theoretical findings using real-world LLM-serving traces, illustrating the trade-offs between algorithmic simplicity, resource utilization, and empirical performance.</p>",
    // },

    {
        id : "Risk_2025",
        name : "Risk-Sensitive Online Selection with Bounded Adaptivity",
...

    {
        ...
        //pubinfo: "",
        //arxiv: "",
        pdf: "https://ojs.aaai.org/index.php/AAAI/article/view/41040",
        //equalContribution: new Array(1, 2),
        recent: "yes",
        representative : "yes",
        topic: "L",
