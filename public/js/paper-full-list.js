var papers_full = new Array ( 
    ...
    //     id : "OACC_2026",
    //     name : "OACC",
    //     coauthors : new Array(authorList.HSang, authorList.BSun, authorList.XQTan),
    //     conference : "Preprint",
    //     //pubinfo: "",
    //     arxiv: "",
    //     //pdf: "/documents/abc.pdf",
    //     //equalContribution: new Array(1, 2),
    //     representative : "no",
    //     topic: "O",
    //     year: "Preprint",
    //     //note: "Full version is available upon request",
    //     paperAbstract : "<p>We study online allocation with convex costs (OACC), a general online optimization framework that unifies and extends several well-studied models, including online convex packing and online combinatorial auctions with production costs. Unlike traditional models with linear and separable objectives, OACC introduces a nonlinear cost function that imposes a monotone convex penalty on the cumulative allocation, presenting new algorithmic challenges. Our main contribution is a systematic characterization of a family of optimal online algorithms using a principled dynamical systems approach. Our results strictly improve upon the best-known guarantees for online convex packing and recover existing optimal algorithms for online combinatorial auctions as special cases within a broader design space. A key insight of this work is a novel interpretation of the competitive ratio—a central performance metric in online algorithm design—through the lens of nonlinear eigenvalue problems in dynamical systems. Specifically, we show that the design of competitive algorithms reduces to solving a nonlinear eigenvalue problem, where the optimal competitive ratio corresponds to the dominant eigenvalue, and the algorithm corresponds to the associated eigenfunction. To the best of our knowledge, this represents the first such interpretation and may open new avenues for analyzing and designing online algorithms beyond the OACC setting.</p>",
    // },

    {
        id : "Risk_2025",
        name : "Posted Pricing for Online Selection: Limited Price Changes and Risk Sensitivity",
        coauthors : new Array(authorList.HNekouyan, authorList.BSun, authorList.RBoutaba, authorList.XQTan),
        conference : "Preprint",
        //pubinfo: "",
        arxiv: "https://arxiv.org/pdf/2512.02427",
        //pdf: "",
        recent: "no",
        representative : "no",
        topic: "R",
        year: "Preprint",
        //note: "Working paper",
        paperAbstract : "<p>Posted-price mechanisms (PPMs) are a widely adopted strategy for online resource allocation owing to their simplicity, intuitive nature, and incentive compatibility. To manage the uncertainty inherent in online settings, PPMs often employ dynamically increasing prices. While this adaptive pricing achieves strong performance, it introduces practical challenges:  dynamically changing prices can lead to fairness concerns due to price discrimination and incur operational costs from frequent updates. This paper addresses these issues by investigating posted pricing constrained by a limited, pre-specified number of allowed price changes, denoted by $\\Delta$. We further extend this framework by incorporating a second critical dimension: risk sensitivity. Instead of evaluating performance based on expectation, we utilize a tail-risk objective—specifically, the Conditional Value at Risk (CVaR) of the total social welfare, parameterized by a risk level $\\delta\\in [0, 1]$. We formally introduce the problem class $\\mathrm{kSelection-}(\\delta, \\Delta)$ and propose a correlated PPM that employs a single random seed to correlate posted prices. This correlation is designed to enhance the tail performance of the online algorithm. Our subsequent analysis provides performance guarantees under these joint constraints, revealing a clear trade-off between the number of allowed price changes and the algorithm's risk sensitivity. We also establish optimality results for several important special cases of the problem.</p>",
    },
    
    {
        id : "OfflineRL_2025",
        name : "Trajectory Data Suffices for Statistically Efficient Policy Evaluation in Finite-Horizon Offline RL with Linear $q^{\\pi}$-Realizability and Concentrability",
        coauthors : new Array(authorList.VTkachuk, authorList.CSzepesvari, authorList.XQTan),
        conference : "Preprint",
        //pubinfo: "",
        arxiv: "https://arxiv.org/pdf/2510.03494",
        //pdf: "",
        recent: "no",
        re : "no",
        topic: "R",
        year: "Preprint",
        //note: "",
        paperAbstract : "<p>We study finite-horizon offline reinforcement learning (RL) with function approximation for both policy evaluation and policy optimization. Prior work established that statistically efficient learning is impossiblefor either of these problems when the only assumptions are that the data has good coverage (concentrability) and the state-action value function of every policy is linearly realizable ($q^{\\pi}$-realizability). Recently, Tkachuk et al. gave a statistically efficient learner for policy optimization, if in addition the data is assumed to be given as trajectories. In this work we present a statistically efficient learner for policy evaluation under the same assumptions. Further, we show that the sample complexity of the learner used by Tkachuk et al. for policy optimization can be improved by a tighter analysis. </p>",
    },
    ...
    {
        id : "kRental_2026",
        name : "Online Rounding and Pricing Schemes for $k$-Rental Problems",
        coauthors : new Array(authorList.HNekouyan, authorList.BSun, authorList.RBoutaba, authorList.XQTan),
        conference : "ACM Web Conference (WWW) 2026",
        //pubinfo: "",
        //arxiv: "",
        pdf: "https://arxiv.org/pdf/2507.19649",
        recent: "yes",
        representative : "yes",
        topic: "O",
        year: "2026",
    ...
    {
        id : "OSA_2026",
        name : "Ordinal Secretaries with Advice",
...

    {
        ...
        //pubinfo: "",
        //arxiv: "",
        pdf: "https://arxiv.org/pdf/2510.21055",
        recent: "yes",
        representative : "yes",
        topic: "L",
        year: "2025",
...

    {
        ...
        topic: "O",
        year: "2024",
        note: "Earlier version was presented in ACM SIGMETRICS 2024 - Workshop on MAMA",
...

    {
        ...
        topic: "O",
        year: "2022",
        note: "Earlier version was presented in ACM SIGMETRICS 2022 - Workshop on MAMA",
...

    {
        ...
        representative : "no",
        selected : "yes",
        note: "Earlier version was presented in ACM SIGMETRICS 2019 - Workshop on MAMA",
        topic: "O",
        year: "2019",
